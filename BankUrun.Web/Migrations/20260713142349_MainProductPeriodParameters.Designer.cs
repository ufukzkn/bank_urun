...
namespace BankUrun.Web.Migrations
{
    ...
    [Migration("20260713142349_MainProductPeriodParameters")]
    partial class MainProductPeriodParameters
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BankUrun.Web.Models.BranchMainProductMonthlyMetric", b =>
                {
                    ...
                    b.HasIndex("MainProductParameterId");
            ...
            modelBuilder.Entity("BankUrun.Web.Models.MainProductParameter", b =>
                {
                    b.HasOne("BankUrun.Web.Models.MainProductInstance", "MainProductInstance")
                        .WithOne("Parameter")
                        .HasForeignKey("BankUrun.Web.Models.MainProductParameter", "MainProductInstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
